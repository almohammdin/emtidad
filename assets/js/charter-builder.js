...
function charterPrintHtml(draft){
 const logo=new URL('assets/images/emtidad-logo.png?v=0.9.0',document.baseURI).href;
...
async function charterDownloadWord(button){
 ...
 try{
  const [D,logo,naif]=await Promise.all([
   ensureDocxLibrary(),
   imageUrlAsBytes(new URL('assets/images/emtidad-logo.png?v=0.9.0',document.baseURI).href),
