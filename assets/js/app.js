...
function printReportLegacy(){
 ...
 const naifUrl=new URL('assets/images/naif-logo-gold.png?v=0.6.8',document.baseURI).href;
...
function printReport(){
 ...
 syncProfileInputs();
 const fileName=reportFileName();
 const logoUrl=new URL('assets/images/emtidad-logo.png?v=0.6.8',document.baseURI).href;
 const naifUrl=new URL('assets/images/naif-logo-gold.png?v=0.6.8',document.baseURI).href;
 const regularUrl=new URL('assets/fonts/TheYearofHandicrafts-Regular.woff2',document.baseURI).href;
 const semiUrl=new URL('assets/fonts/TheYearofHandicrafts-SemiBold.woff2',document.baseURI).href;
 const blackUrl=new URL('assets/fonts/TheYearofHandicrafts-Black.woff2',document.baseURI).href;
...
async function buildResultImageCanvas(){
 ...
 const [logo,naif,...socialIcons]=await Promise.all([
  loadCanvasImage(new URL('assets/images/emtidad-logo.png?v=0.6.8',document.baseURI).href),
  loadCanvasImage(new URL('assets/images/naif-logo-gold.png?v=0.6.8',document.baseURI).href),
...
function templateDocumentHtml(i,mode='print',embeddedImages={}){
 ...
 const logoUrl=embeddedImages.logo||new URL('assets/images/emtidad-logo.png?v=0.6.8',document.baseURI).href;
 const naifUrl=embeddedImages.naif||new URL('assets/images/naif-logo-gold.png?v=0.6.8',document.baseURI).href;
...
async function downloadTemplateWord(i){
 ...
 try{
  const [D,logo,naif]=await Promise.all([
   ...
   imageUrlAsBytes(new URL('assets/images/naif-logo-gold.png?v=0.6.8',document.baseURI).href)
  ]);
