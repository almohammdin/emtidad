...
function printReport(){
 ...
 const logoUrl=new URL('assets/images/emtidad-logo.png?v=0.9.2',document.baseURI).href;
 const naifUrl=new URL('assets/images/naif-logo-gold.png?v=0.9.2',document.baseURI).href;
...
async function buildResultImageCanvas(){
 ...
 const [logo,naif,...socialIcons]=await Promise.all([
  loadCanvasImage(new URL('assets/images/emtidad-logo.png?v=0.9.2',document.baseURI).href),
  loadCanvasImage(new URL('assets/images/naif-logo-gold.png?v=0.9.2',document.baseURI).href),
...
function templateDocumentHtml(i,mode='print',embeddedImages={}){
 ...
 const logoUrl=embeddedImages.logo||new URL('assets/images/emtidad-logo.png?v=0.9.2',document.baseURI).href;
 const naifUrl=embeddedImages.naif||new URL('assets/images/naif-logo-gold.png?v=0.9.2',document.baseURI).href;
...
async function downloadTemplateWord(i){
 ...
 try{
  const [D,logo,naif]=await Promise.all([
   ...
   imageUrlAsBytes(new URL('assets/images/naif-logo-gold.png?v=0.9.2',document.baseURI).href)
  ]);
